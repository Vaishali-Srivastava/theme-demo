...
import '../../node_modules/react-custom-scrollbar/lib/react-custom-scrollbar.css';
import '../css/custom-table.css';

class BodyFirst extends Component {
  render() {
    return (
      <div>
        <div>
          ...
          >
          <Table responsive striped bordered hover condensed className="custom-table">
            <thead>
              <tr>
                <th>#</th>
                <th>Table heading</th>
